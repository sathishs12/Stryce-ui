...
//         <div className="relative w-full h-[200px] md:w-[220px] md:h-auto shrink-0 bg-gray-100">
//   <img
...
function CreatorCard({ 
  ...
  return (
    <div className="w-full max-w-[620px] mx-auto">
      ...
      <div className="block md:hidden">
        <div className="relative rounded-[28px] overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
  ...
  className="flex-1 border border-white/40 rounded-full py-2 text-sm font-medium text-center"
>
  View Profile
</Link>
              <button 
                onClick={onUnlock}
                className="flex-1 bg-red-500 text-white rounded-full py-2 text-sm font-medium"
              >
                Unlock Contact
              </button>
            </div>
