...
>
  ...
  className="flex-1 flex items-center justify-center gap-1.5 sm:gap-2 border border-gray-200 rounded-lg py-2 sm:py-2.5 text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50 transition"
>
