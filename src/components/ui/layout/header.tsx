            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="w-[300px] p-0 border-l-0">
                ...
                <div className="p-4 space-y-1">
                  ...
                  <MobileNavItem icon={LayoutDashboard} label="Company Dashboard" />
                  <MobileNavItem icon={UserSquare2} label="Freelancer Dashboard" />
                  <MobileNavItem icon={ShieldCheck} label="Admin" />
                </div>
